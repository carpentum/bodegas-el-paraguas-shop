...
jQuery('document').ready(function() {
	$("input:radio[name=advanced_payment], input:radio[name=fee_discount]").click(function() {
		toggleFields($(this).attr('name'));
	});

	toggleFields('fee_discount');
	toggleFields('advanced_payment');
    $('#form-redsys_transaction').attr('novalidate','novalidate');
    $('#form-redsys_refund').attr('novalidate','novalidate');
});
