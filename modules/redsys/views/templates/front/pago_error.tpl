...
<div class="redsys_ko card">
    ...
    {l s='Try again or contact with our' mod='redsys'} <b><a href="{$link->getPageLink('contact', true)|escape:'html'}">{l s='customer service department.' mod='redsys'}</a></b>.
</div>