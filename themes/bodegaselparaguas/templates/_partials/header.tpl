...
<div class="row header-wrapper">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="http://www.bodegaselparaguas.com">
                    <img src="http://www.bodegaselparaguas.com/wp-content/uploads/2017/12/logo_109x125.png" alt="Logo ">
                    <span></span>
                </a>
                <span class="header-txt-container">
                    <img src="http://www.bodegaselparaguas.com/wp-content/uploads/2018/09/banner_animado_es.gif" class="img-responsive" style="margin-top:45px;">
                </span>
            </div>
    ...
    <div class="col-md-6 col-sm-6 col-sm-offset-0 hidden-xs header-txt-container">
        <img src="http://www.bodegaselparaguas.com/wp-content/uploads/2018/09/banner_animado_es.gif" class="img-responsive">
    </div>
    <header id="masthead" class="site-header col-md-2 offset-md-1 col-sm-3" role="banner">
        <div class="site-header-main">
            <div class="site-branding">
                <a href="http://www.bodegaselparaguas.com/es_ES/" class="custom-logo-link" rel="home" itemprop="url"><img width="109" height="125" src="http://www.bodegaselparaguas.com/wp-content/uploads/2017/12/logo_109x125.png" class="custom-logo" alt="" itemprop="logo"></a>
