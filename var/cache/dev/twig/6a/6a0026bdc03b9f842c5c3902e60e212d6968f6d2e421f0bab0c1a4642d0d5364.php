...
class __TwigTemplate_9f173fc882727954544945c0d4abfcda4545969b5339c31befa2b1fbbe51e701 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 42
        if (((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 42, $this->source); })()), "actions", [], "any", false, false, false, 42), "bulk", [], "any", false, false, false, 42)), 0)) || (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 42, $this->source); })()), "filter_form", [], "any", false, false, false, 42)), 1)))) {
            // line 43
            echo "      ";
