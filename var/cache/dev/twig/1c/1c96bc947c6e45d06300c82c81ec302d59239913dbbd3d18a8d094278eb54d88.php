...
class __TwigTemplate_ae1b8eced203d48bc6e1312fbbf07eb7ee25ad2d0e70a25cb99744f140336033 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_module_actions($context, array $blocks = [])
    {
        ...
        // line 99
        echo "            ";
        if (((isset($context["requireBulkActions"]) || array_key_exists("requireBulkActions", $context)) && (0 === twig_compare((isset($context["requireBulkActions"]) || array_key_exists("requireBulkActions", $context) ? $context["requireBulkActions"] : (function () { throw new RuntimeError('Variable "requireBulkActions" does not exist.', 99, $this->source); })()), true)))) {
            // line 100
