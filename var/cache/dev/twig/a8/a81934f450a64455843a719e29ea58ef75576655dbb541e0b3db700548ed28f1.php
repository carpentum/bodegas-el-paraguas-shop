...
class __TwigTemplate_d08bde49831d424055bfffc997a9d5f9733da4844d43cd394a369c6029d39eae extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"row\">
    ...
    ";
        // line 49
        if (((isset($context["requireFilterStatus"]) || array_key_exists("requireFilterStatus", $context)) && (0 === twig_compare((isset($context["requireFilterStatus"]) || array_key_exists("requireFilterStatus", $context) ? $context["requireFilterStatus"] : (function () { throw new RuntimeError('Variable "requireFilterStatus" does not exist.', 49, $this->source); })()), true)))) {
            // line 50
            echo "      <div class=\"col-md-4 module-top-menu-item\">
        <h3>";
            // line 51
    ...
    ";
        // line 56
        if (((1 === twig_compare((isset($context["level"]) || array_key_exists("level", $context) ? $context["level"] : (function () { throw new RuntimeError('Variable "level" does not exist.', 56, $this->source); })()), twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_UPDATE"))) && (isset($context["bulkActions"]) || array_key_exists("bulkActions", $context)))) {
            // line 57
