...
class __TwigTemplate_e3cd773c7aa527a2e1abfc4a82df64ba13bb714edf3cb7fbad54cc93010a7f2b extends Template
{
    private $source;
    private $macros = [];
...
<script>
    \$(document).ready(function() {
        var closable = ";
        // line 82
        if (((isset($context["closable"]) || array_key_exists("closable", $context)) && (0 === twig_compare(($context["closable"] ?? null), true)))) {
            echo "true";
        } else {
            echo "false";
        }
